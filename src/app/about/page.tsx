...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "heltleo59@gmail.com",
    href: "mailto:heltleo59@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/sr-dev/",
    content: "/sr-dev",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/heltleo",
    content: "/sr-dev",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Sr Dev</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! Here is a Fullstack developer passionate about
